...
import com.example.ebook.service.BookStoreService;
...
public class BookStoreController {
    ...
    public ResponseEntity<Optional<Book>> getBookById(@PathVariable("book_id") ObjectId id) {
    ...
    public ResponseEntity<Void> deleteBookById(@PathVariable("book_id") ObjectId id) {
